...
class Configs(Base):
    OUTPUTDIR="../workdir/listmle_graphsage_tune"

    TRAIN_DATA_PATH="/app/dataset/various_splits/tuning_layout/train"
    VALID_DATA_PATH="/app/dataset/various_splits/tuning_layout/valid"
    TEST_DATA_PATH="/app/dataset/various_splits/tuning_layout/test"
    ...
    def __init__(self,inference_files=None,inference_text=None,use_numpy=False):
        ...
        self.model_dims = GraphModelArugments(
            ...
            project_after_graph_encoder = False,
            graphsage_aggr = "mean",
