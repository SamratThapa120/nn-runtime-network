...
class Configs(Base):
    OUTPUTDIR="../workdir/listmle_graphsage_xlanlp_fused_histo"

    TRAIN_DATA_PATH="/app/dataset/various_splits/xla_nlp_fused/train/*/"
    VALID_DATA_PATH="/app/dataset/various_splits/xla_nlp_fused/valid"
    TEST_DATA_PATH="/app/dataset/various_splits/xla_nlp_fused/test"
