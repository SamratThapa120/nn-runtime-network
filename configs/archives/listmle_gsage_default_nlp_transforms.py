...
from ml_graph_timer.dataset.transforms import AddFeatures,LogNormalization,ComposeAll,RemoveFeaturesAfterFE,RemoveFeatures
...
class Configs(Base):
    OUTPUTDIR="../workdir/listmle_graphsage_default_nlp_newfeats_with_conf_replace"
