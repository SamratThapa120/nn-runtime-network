...
from ml_graph_timer.dataset.transforms import AddFeatures,LogNormalization,RemoveFeatures,ComposeAll,FixFeatureNoise
...
class Configs(Base):
    OUTPUTDIR="../workdir/listmle_graphsage_fused_xla_filtered"
